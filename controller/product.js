...
const createProduct = async (req, res) => {
  try {
    const { name, price, sku, categoryId, stockQuantity, description, modelNo, code, material } = req.body;
    let images = [];
    ...
    const [insertResult] = await db.query(
      `INSERT INTO product (name, price, sku, categoryId, stockQuantity, description, modelNo, code, material, image)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
      [name, price, sku, categoryId, stockQuantity, description, modelNo, code, material, JSON.stringify(images)]
    );
